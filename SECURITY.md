...
BotOps Manager does not need application credentials. Keep bot secrets outside this repository and outside diagnostic exports. Review every launcher before enabling control, and use monitor-only mode for processes BotOps did not start.
